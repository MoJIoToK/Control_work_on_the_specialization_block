...
public class PetRepository implements Repository<Pet> {
    ...
    public List<Pet> getAll() {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "SELECT genus, ID, name, birthday FROM cats ORDER BY ID";
    ...
    public Pet getById(int petId) {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "SELECT genus, ID, name, birthday FROM pet_list WHERE Id = ?";
    ...
    public int create(Pet pet) {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "INSERT INTO pet_list (name, birthday, genus) SELECT ?, ?, (SELECT Id FROM pet_types WHERE Genus_name = ?)";
                PreparedStatement prepSt = dbConnection.prepareStatement(SQLstr);
    ...
    public void train (int id, String command){
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            try (Connection dbConnection = getConnection()) {
                String SQLstr = "INSERT INTO pet_command (PetId, command) SELECT ?, (SELECT ID FROM commands WHERE Command_name = ?)";
                PreparedStatement prepSt = dbConnection.prepareStatement(SQLstr);
                prepSt.setInt(1, id);
